...
class alien_skill(Skill):
	...
	def act_on_intent(self, intent, text):
		...
		if intent_type == 'AboutAlien':
			...
			rep = "You lie in a clearing among the birch trees, in tall grass. Among blue, red, and orange wildflowers. The sun is strong on your skin. You feel your entire body supported by cool ground. You put your jacket over your face to shade your eyes. Do you focus on sound or smell?"
			response.append({
				'file': "04",
				'response': rep    
			})
			...
			rep = "It hasn't rained for a long time and everything is dry, making more sound. You hear a distant roar from the huge waterfall a kilometer away. The tinkling of a closer stream. Cicadas hum in the trees and the bushes around the clearing. Their sound rises and falls in waves. The sun is silent but strong. It seems almost to suspend all sound with its glare. It's noon, then it's 3pm, and then the sun starts to move downward, easing out. You relax. Say 'restart' to begin again or 'menu' to hear your options."
			response.append({
				'file': "05",
				'response': rep    
			})
			...
			rep = "A slow rain begins. It's the first time it's rained in months. The smell of the dry grass and leaves changes, shifts, mixes with the weight of the water. You feel the rain falling steadily on your body. Your head, under the tent remains dry. The water drips onto the fabric above your head. Listen. Relax. Say 'restart' to begin again. Or say 'menu' to hear your options."
			response.append({
				'file': "07",
				'response': rep    
			})
			...
			self.ContextManager.remove_context("BirchwoodShadeContext")
			rep = "The sun goes entirely behind a cloud before emerging again in full brilliance. Then another cloud. You notice this only through the feeling of the light. Your eyes are closed. Time slows, time becomes the clouds. You relax. Say 'restart' to begin again. Or say 'menu' to hear your options."
			response.append({
				'file': "08",
				'response': rep    
			})
			...
			self.ContextManager.remove_context("BirchwoodSunContext")
			rep = "It hasn't rained for months. The dry grass and leaves create a smell that reminds you of childhood summers. The height of August when the air is full of water that hasn't fallen. The breeze sometimes brings you the gathered scent of the flowers in the field. It comes, and it goes. Sometimes the breeze brings also the smell of dust. You relax. Say 'restart' to begin again. Or say 'menu' to hear your options."
			response.append({
				'file': "09",
				'response': rep    
			})
			...
			rep = "My planet is a place of tentacles. When we Ohaiglo return, our tentacles connect to the many-armed being. We at first adjoin the tentacles before absorbed. My planet would understand your limbs as tentacles and absorb you similarly. Do you want to focus on the senstation or the sound of the absorption?"
			response.append({
				'file': "10",
				'response': rep    
			})
			...
			self.ContextManager.remove_context("HomePlanetContext")
			rep = "Absorption is not scary. At first, it is like you are held with a steady grip on your hands and legs. Held by many people who come to you with good intentions. The grip turns into a reassuring weight. Feel it moving from your feet, to your shins to your thighs. Likewise, from your hands, to arms, to shoulders. Until your body is completely relaxed under a reassuring heaviness. The light disappears. You fall into a deep slumber, in a state of deep ease. Say 'restart' to begin again or 'menu' to hear your options."
			response.append({
				'file': "13",
				'response': rep    
			})
